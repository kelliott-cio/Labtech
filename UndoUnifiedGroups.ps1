...
}}}| Export-CSV "C:\temp\UnifiedGroupMembers.csv" -NoTypeInformation -Encoding UTF8
$distro = Import-Csv C:\temp\UnifiedGroupMembers.csv | sort GroupEmail –Unique
...
Import-CSV "C:\temp\UnifiedGroupMembers.csv" | foreach {Add-DistributionGroupMember -identity $_.GroupEmail -member $_.EmailAddress} 
	}
