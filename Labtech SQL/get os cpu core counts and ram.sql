...
LEFT JOIN Software ON (Software.ComputerId = Computers.ComputerId)
  WHERE (((((
    ...
    OR (Software.Name = 'Microsoft Office Pro') 
    OR (Software.Name = 'Microsoft Office XP') 
    OR (Software.Name = 'Microsoft Office Home'))))))
